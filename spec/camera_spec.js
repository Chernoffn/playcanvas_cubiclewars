describe("Camera", function() {
  ...
  it("moves the entity left when the mouse hits the left margin", function() {
    ...
    expect(entity.getPosition().x).toBeCloseTo(-camera.scrollSpeed);
  });
  ...
  it("keeps moving the entity left on each update", function() {
    ...
    expect(entity.getPosition().x).toBeCloseTo(-(camera.scrollSpeed * 2));
  });
  ...
  it ("can move up when close to the top", function() {
    ...
    expect(entity.getPosition().z).toBeCloseTo(camera.scrollSpeed);
  });
